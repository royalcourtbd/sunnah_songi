...
///
/// The `SunnahScreen` class provides static methods and properties to access
...
/// ```dart
/// SunnahScreen.setUp();
/// double screenWidth = SunnahScreen.width;
/// double screenHeight = SunnahScreen.height;
/// ```
///
/// Rationale:
///
/// - The `SunnahScreen` class provides a convenient way to access the screen dimensions
...
/// the `SunnahScreen` class benefits from its reliability and compatibility with different
...
class SunnahScreen {
  ...
  static Size get _size => MediaQuery.sizeOf(SunnahSongi.globalContext);
  ...
  static void _resetIfInvalid() {
    if (_width! < 10 || _height! < 10) {
      logErrorStatic(
        'SunnahScreen size not initialized. Please initialize SunnahScreen and try again.',
        "quran_screen",
      );
      _width = null;
      _height = null;
...
extension SunnahScreenWidth on Widget {
  ...
  double get twoPercentWidth {
    ...
    _twoPercentWidth ??= SunnahScreen.width * twoPercent;
  ...
  double get fiftyPercentHeight {
    ...
    _fiftyPercentHeight ??= SunnahScreen.height * fiftyPercent;
  ...
  double get threePercentWidth {
    ...
    _threePercentWidth ??= SunnahScreen.width * threePercent;
  ...
  double get sixPercentWidth {
    ...
    _sixPercentWidth ??= SunnahScreen.width * sixPercent;
  ...
  double get sevenPercentWidth {
    ...
    _sevenPercentWidth ??= SunnahScreen.width * sevenPercent;
  ...
  double get eightPercentWidth {
    ...
    _eightPercentWidth ??= SunnahScreen.width * eightPercent;
  ...
  double get tenPercentWidth {
    ...
    _tenPercentWidth ??= SunnahScreen.width * tenPercentWidth;
  ...
  double get fortyPercentWidth {
    ...
    _fortyPercentWidth ??= SunnahScreen.width * fortyPercent;
  ...
  double get thirtyPercentWidth {
    ...
    _thirtyPercentWidth ??= SunnahScreen.width * thirtyPercentWidth;
  ...
  double get seventyPercentWidth {
    ...
    _seventyPercentWidth ??= SunnahScreen.width * seventyPercent;
  ...
  double get tweentyEightPercentWidth {
    ...
    _tweentyEightPercentWidth ??= SunnahScreen.width * tweentyEightPercentWidth;
  ...
  double get twentyPercentWidth {
    ...
    _twentyPercentWidth ??= SunnahScreen.width * twentyPercentWidth;
  ...
  double get twentyFivePercentWidth {
    ...
    _twentyFivePercentWidth ??= SunnahScreen.width * twentyFivePercentWidth;
  ...
  double get twentySixPercentWidth {
    ...
    _twentySixPercentWidth ??= SunnahScreen.width * twentySixPercentWidth;
  ...
  double get twentyThreePercentWidth {
    ...
    _twentyThreePercentWidth ??= SunnahScreen.width * twentyThreePercentWidth;
  ...
  double get fourtyPercentWidth {
    ...
    _fourtyPercentWidth ??= SunnahScreen.width * fourtyPercentWidth;
  ...
  double get twentyPercentHeight {
    ...
    _twentyPercentHeight ??= SunnahScreen.height * twentyPercent;
  ...
  double get tenPercentHeight {
    ...
    _tenPercentHeight ??= SunnahScreen.height * tenPercentHeight;
  ...
  double get twelvePercentHeight {
    ...
    _twelvePercentHeight ??= SunnahScreen.height * twentyPercent;
  ...
  double get fourteenPercentHeight {
    ...
    _fourteenPercentHeight ??= SunnahScreen.height * fourteenPercentHeight;
  ...
  double get tweentyPercentHeight {
    ...
    _tweentyPercentHeight ??= SunnahScreen.height * tweentyPercentHeight;
...
/// `_widthPercent`, and `_SunnahScreenWidthQuarterPercentage`), subsequent conversions for the same
...
extension DeviceExt on num {
  ...
  /// `_calculateSunnahScreenWidthQuarterPercentage` function.
  ///
  ///
  /// Example usage:
  ///
  ...
  /// ```
  double get px {
    _SunnahScreenWidthQuarterPercentage ??=
        _calculateSunnahScreenWidthQuarterPercentage();
    return this * (_SunnahScreenWidthQuarterPercentage ?? 0);
  }
  ...
  double get percentHeight {
    _heightPercent ??= SunnahScreen.height / 100;
  ...
  double get percentWidth {
    _widthPercent ??= SunnahScreen.width / 100;
...
///
/// The `_calculateSunnahScreenWidthQuarterPercentage` function calculates and returns
...
///
/// This function assumes that the `SunnahScreen` class, containing the width property,
/// is properly defined and accessible within the scope of this function.
double _calculateSunnahScreenWidthQuarterPercentage() {
  return (SunnahScreen.width / 3.9) / 100;
}
